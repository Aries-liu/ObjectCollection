...
def main (directory, source):
  ...
  os.system('clang++ -std=c++11 -static -g   -S -fno-slp-vectorize -fno-vectorize ' + \
  ...
  os.system('llc -O3 -disable-fp-elim -filetype=asm -o full.s full.llvm')
  os.system('g++  -O3 -fno-inline -o ' + executable + ' full.s -lm -lz ')
